package com.eloancn.framework.activiti.web.demo.activitimul;
 ...
 */
@Controller
@RequestMapping(value = "/demo/activitimul")
public class ActivitMulDemoController {
    ...
    private final String processDefinitionKey = "multiInstance-demo";

    @RequestMapping(value = {"apply", ""})
    public String createForm(Model model) {
        return "/demo/activitimul/apply";
    }
    ...
    public String startWorkflow(RedirectAttributes redirectAttributes, HttpSession session,String nextUsers) {
        ...
        return "redirect:/demo/activitimul/apply";
    }
    ...
    public ModelAndView taskList(HttpSession session, HttpServletRequest request) {
        ...
        ModelAndView mav = new ModelAndView("/demo/activitimul/taskList");
    ...
    public ModelAndView runningList(HttpSession session,HttpServletRequest request) {
        ...
        ModelAndView mav = new ModelAndView("/demo/activitimul/running");
        Page<TaskResult> page = new Page<TaskResult>(PageUtil.PAGE_SIZE);
    ...
    public ModelAndView finishedList(HttpSession session,HttpServletRequest request) {
        ...
        String userId = ActivitiUtils.getUserIDFromSession(session);
        ModelAndView mav = new ModelAndView("/demo/activitimul/finished");
        Page<TaskResult> page = new Page<TaskResult>(PageUtil.PAGE_SIZE);
        PageUtil.init(page, request);
    ...
    public String claim(@PathVariable("id") String taskId, HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/demo/activitimul/list/task";
    }
