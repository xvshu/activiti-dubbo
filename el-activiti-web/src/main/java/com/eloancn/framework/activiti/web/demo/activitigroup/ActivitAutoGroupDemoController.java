package com.eloancn.framework.activiti.web.demo.activitigroup;
 ...
 */
@Controller
@RequestMapping(value = "/demo/activitigroup")
public class ActivitAutoGroupDemoController {
    ...
    private final String processDefinitionKey = "autogroup";

    @RequestMapping(value = {"apply", ""})
    public String createForm(Model model) {
        return "/demo/activitigroup/apply";
    }
    ...
    public String startWorkflow(int day,RedirectAttributes redirectAttributes, HttpSession session) {
        ...
        return "redirect:/demo/activitigroup/apply";
    }
    ...
    public ModelAndView taskList(HttpSession session, HttpServletRequest request) {
        ...
        ModelAndView mav = new ModelAndView("/demo/activitigroup/taskList");
    ...
    public ModelAndView runningList(HttpSession session,HttpServletRequest request) {
        ...
        ModelAndView mav = new ModelAndView("/demo/activitigroup/running");
        Page<TaskResult> page = new Page<TaskResult>(PageUtil.PAGE_SIZE);
    ...
    public ModelAndView finishedList(HttpSession session,HttpServletRequest request) {
        ...
        String userId = ActivitiUtils.getUserIDFromSession(session);
        ModelAndView mav = new ModelAndView("/demo/activitigroup/finished");
        Page<TaskResult> page = new Page<TaskResult>(PageUtil.PAGE_SIZE);
        PageUtil.init(page, request);
    ...
    public String claim(@PathVariable("id") String taskId, HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/demo/activitigroup/list/task";
    }
