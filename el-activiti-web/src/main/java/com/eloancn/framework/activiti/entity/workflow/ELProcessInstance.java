...
public class ELProcessInstance {
    ...
    public static ELProcessInstance covert(ProcessInstance processInstance) {
        ...
        eLProcessInstance.setNowActiviNoteName(ProcessDefinitionCache.getActivityName(processInstance.getProcessDefinitionId(), ObjectUtils.toString(processInstance.getActivityId())));
